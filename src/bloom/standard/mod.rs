...
mod tests {
    ...
    fn bloom_calculate_m() {
        assert_eq!(9_592, StandardBloomFilter::calculate_m(1_000, 0.01));
        assert_eq!(4_800, StandardBloomFilter::calculate_m(1_000, 0.1));
        assert_eq!(4_792_536, StandardBloomFilter::calculate_m(1_000_000, 0.1));
    }
